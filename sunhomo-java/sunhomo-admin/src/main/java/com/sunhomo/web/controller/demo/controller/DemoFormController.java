...
import com.sunhomo.common.json.JSONObject;
import com.sunhomo.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "sunhomo 1", "sunhomo 2", "sunhomo 3", "sunhomo 4", "sunhomo 5" };
        AjaxResult ajax = new AjaxResult();
