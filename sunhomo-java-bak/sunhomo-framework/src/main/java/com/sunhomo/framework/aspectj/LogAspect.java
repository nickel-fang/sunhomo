package com.sunhomo.framework.aspectj;
...
import com.sunhomo.common.enums.BusinessStatus;
import com.sunhomo.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.sunhomo.common.annotation.Log)")
